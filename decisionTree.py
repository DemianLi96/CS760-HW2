...
def get_information_gain_ratio(dataset, idx, threshold=None):
    ...
    return information_gain / (split_information+1e-5), conditional_entropy
...
def find_best_split(dataset):
    ...
    for i in range(dimension_num):
        ...
        for threshold in thresholds:
            gain_ratio, conditional_entropy = get_information_gain_ratio(dataset, i, threshold)
    ...
    return best_idx, best_threshold, best_gain_ratio, best_conditional_entropy
...
def make_subtree(dataset):
    ...
    best_idx, best_threshold, best_gain_ratio, best_conditional_entropy = find_best_split(dataset)
